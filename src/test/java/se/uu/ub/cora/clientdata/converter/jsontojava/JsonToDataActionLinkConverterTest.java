...
public class JsonToDataActionLinkConverterTest {
	...
	public void testToClassWithNecessaryContent() {
		...
		assertEquals(clientDataActionLink.getURL(), "https://cora.epc.ub.uu.se/systemone/rest/record/presentationGroup/loginFormNewPGroup");
	...
	public void testToClassWithExtraContent() {
		...
		assertEquals(clientDataActionLink.getURL(), "https://cora.epc.ub.uu.se/systemone/rest/record/workOrder/");
		...
		assertEquals(clientDataActionLink.getBody(), factory.factoredConverters.get(0).returnedElement);
	}
}
